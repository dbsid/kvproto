...
type Store struct {
	...
	// sql_address is the optional embedded MySQL endpoint advertised by a CSE
	// store. It is empty for ordinary TiKV stores.
	SqlAddress string `protobuf:"bytes,14,opt,name=sql_address,json=sqlAddress,proto3" json:"sql_address,omitempty"`
}
...
func (m *Store) GetSqlAddress() string {
	if m != nil {
		return m.SqlAddress
	}
	return ""
...
// TableGroupRegionMeta identifies the Table Group metadata applied to a Region.
// The enclosing Region is an ordinary, splittable Region when this message is absent.
// Consumers must fail closed when this message is present but incomplete or conflicts
// with the authoritative Table Group record.
type TableGroupRegionMeta struct {
	// keyspace_id is part of the immutable Table Group identity. Zero is a valid
	// keyspace ID and does not indicate absence by itself.
	...
	// applied_metadata_version is the authoritative Table Group metadata version
	// durably applied by this Region. It is non-zero and monotonically increasing.
	AppliedMetadataVersion uint64 `protobuf:"varint,3,opt,name=applied_metadata_version,json=appliedMetadataVersion,proto3" json:"applied_metadata_version,omitempty"`
	// fragment_id identifies the zero-based Table Group fragment owned by this
	// Region. Legacy single-Region groups use zero.
	FragmentId uint32 `protobuf:"varint,4,opt,name=fragment_id,json=fragmentId,proto3" json:"fragment_id,omitempty"`
}

func (m *TableGroupRegionMeta) Reset()         { *m = TableGroupRegionMeta{} }
func (m *TableGroupRegionMeta) String() string { return proto.CompactTextString(m) }
func (*TableGroupRegionMeta) ProtoMessage()    {}
func (*TableGroupRegionMeta) Descriptor() ([]byte, []int) {
	return fileDescriptor_77b4d575d5a68dda, []int{7}
}
func (m *TableGroupRegionMeta) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TableGroupRegionMeta) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TableGroupRegionMeta.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *TableGroupRegionMeta) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TableGroupRegionMeta.Merge(m, src)
}
func (m *TableGroupRegionMeta) XXX_Size() int {
	return m.Size()
}
func (m *TableGroupRegionMeta) XXX_DiscardUnknown() {
	xxx_messageInfo_TableGroupRegionMeta.DiscardUnknown(m)
}

var xxx_messageInfo_TableGroupRegionMeta proto.InternalMessageInfo

func (m *TableGroupRegionMeta) GetKeyspaceId() uint32 {
	if m != nil {
		return m.KeyspaceId
	}
	return 0
...
func (m *TableGroupRegionMeta) GetTableGroupId() uint64 {
	if m != nil {
...
func (m *TableGroupRegionMeta) GetAppliedMetadataVersion() uint64 {
	if m != nil {
...
func (m *TableGroupRegionMeta) GetFragmentId() uint32 {
	if m != nil {
		return m.FragmentId
	}
	return 0
...
type Region struct {
	...
	// table_group is present only for a Region protected by Table Group policy.
	// The full Table Group record remains outside Region heartbeat metadata.
	TableGroup *TableGroupRegionMeta `protobuf:"bytes,9,opt,name=table_group,json=tableGroup,proto3" json:"table_group,omitempty"`
}
...
func (m *Region) GetTableGroup() *TableGroupRegionMeta {
	if m != nil {
		return m.TableGroup
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*TableGroupRegionMeta)(nil), "metapb.TableGroupRegionMeta")
...
var fileDescriptor_77b4d575d5a68dda = []byte{
	...
	,
}
...
func (m *Store) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.SqlAddress) > 0 {
		...
		i = encodeVarintMetapb(dAtA, i, uint64(len(m.SqlAddress)))
		i--
		dAtA[i] = 0x72
	}
	if m.NodeState != 0 {
...
func (m *TableGroupRegionMeta) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TableGroupRegionMeta) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TableGroupRegionMeta) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.FragmentId != 0 {
		i = encodeVarintMetapb(dAtA, i, uint64(m.FragmentId))
		i--
		dAtA[i] = 0x20
	}
	if m.AppliedMetadataVersion != 0 {
		i = encodeVarintMetapb(dAtA, i, uint64(m.AppliedMetadataVersion))
		i--
		dAtA[i] = 0x18
	}
	if m.TableGroupId != 0 {
		i = encodeVarintMetapb(dAtA, i, uint64(m.TableGroupId))
		i--
		dAtA[i] = 0x10
	}
	if m.KeyspaceId != 0 {
...
func (m *TableGroupRegionMeta) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.TableGroupId != 0 {
		n += 1 + sovMetapb(uint64(m.TableGroupId))
	}
	if m.AppliedMetadataVersion != 0 {
		n += 1 + sovMetapb(uint64(m.AppliedMetadataVersion))
	}
	if m.FragmentId != 0 {
		n += 1 + sovMetapb(uint64(m.FragmentId))
	}
	return n
}
...
func (m *TableGroupRegionMeta) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TableGroupRegionMeta: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TableGroupRegionMeta: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *Region) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			...
			if m.TableGroup == nil {
				m.TableGroup = &TableGroupRegionMeta{}
			}
